...
import { TabsTopRoundTeams } from "./TabsTopRoundTeams";
...
export const TabsTopAnalytics = (props) => {
  const { event, location, season } = props;
  ...
  const tabs = [
    {
      ...
      content: (
        <>
          <TabsTopRoundTeams location={location} season={season} division={event} />
        </>
      ),
    },
    {
      ...
      content: (
        <>
          {/* <StatsPlayer002Fire location={location} season={season}  division={event} /> */}
          <TabsTopRoundTeams location={location} season={season} division={event} />
        </>
      ),
    },
